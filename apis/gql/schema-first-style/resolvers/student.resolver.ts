    ...
    update: (_, {
      ...
      if (information) {
        ...
        if (information.department) {
          targetStudent.information.department = information.department;
        }
        if (information.major) {
          targetStudent.information.major = information.major;
        }
        if (information.semester) {
          targetStudent.information.semester = information.semester;
        }
        if (information.doubleMajor) {
          targetStudent.information.doubleMajor = information.doubleMajor;
        }
      }
